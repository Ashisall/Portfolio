...
const translations = {
  en: {
    ...
    'card-approval-cat':   'Dashboard',
    'card-approval-title': 'Madfu Business — The Merchant Approval Portal',
    'card-approval-sub':   'Internal approval system for 4 teams — BD, Compliance, Credit, and Operations — reviewing merchant applications in one shared portal',
    ...
    'test1-quote':  '"Working with Rana over the past two years has genuinely been one of the smoothest and most rewarding collaborations I\'ve had. She never designed just for aesthetics — every decision had purpose, logic, and impact on the overall product journey. Having someone who can think strategically, communicate clearly, and collaborate efficiently across teams makes a massive difference, and Rana consistently delivered on all fronts. Any team working with Rana is genuinely lucky to have her."',
    ...
    'test4-role':   'Regional Product Head, Orascom Investment Group',
  ...
  ar: {
    ...
    'card-approval-cat':   'لوحة تحكم',
    'card-approval-title': 'مدفوع بيزنس — بوابة الموافقة على التجار',
    'card-approval-sub':   'نظام موافقة داخلي لـ 4 فرق — التطوير التجاري، الامتثال، الائتمان، والعمليات — لمراجعة طلبات التجار في بوابة موحدة',
    ...
    'test1-quote':  '"العمل مع رنا على مدار سنتين كان من أكثر التعاونات سلاسة وإثراءً. ما كانت تصمم لأجل الجماليات فقط — كل قرار كان له غرض ومنطق وأثر على مسار المنتج. وجود شخص يفكر استراتيجياً ويتواصل بوضوح ويتعاون بكفاءة مع الفرق يصنع فرقاً كبيراً، ورنا كانت دائماً عند المستوى. أي فريق يعمل معها هو محظوظ فعلاً."',
    ...
    'test4-role':   'رئيس المنتج الإقليمي، مجموعة أوراسكوم للاستثمار',
